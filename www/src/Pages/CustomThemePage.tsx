							...
							<Stack>
								<div className="d-flex justify-content-between">
									<div className="d-flex d-none d-md-block">
										<ul>
											<li>
												Click a button to bring up the normal and pressed color
												selection.
											</li>
											<li>
												Click on the controller background to dismiss the color
												selection.
											</li>
											<li>
												Right-click a button to preview the button's pressed
												color.
											</li>
										</ul>
									</div>
							...
							<Container className="led-color-picker">
								<h6 className="text-center">
									{specialButtons.indexOf(selectedButton) > -1
										? selectedButton
										: BUTTONS[buttonLabels][selectedButton]}
								</h6>
								<Row>
									<Form.Group
										as={Col}
